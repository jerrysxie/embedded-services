...
impl<'a> Device<'a> {
    ...
    pub async fn receive(&self) -> deferred::Request<GlobalRawMutex, Command, Response<'static>> {
...
impl ContextToken {
    ...
    pub async fn wait_external_command(
        &self,
    ) -> deferred::Request<GlobalRawMutex, external::Command, external::Response<'static>> {
